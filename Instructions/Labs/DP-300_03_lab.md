...
**Lab files**: The files for this lab are in the C:\LabFiles\DP-300T00-Administering-Relational-Databases-on-Azure\Allfiles\Labs\Secure Environment folder.
...
8. In the Import Settings screen, click **Browse** and navigate to C:\LabFiles\DP-300T00-Administering-Relational-Databases-on-Azure\Allfiles\Labs\Secure Environment folder and click on the **AdventureWorks.bacpac** file and click **open**. Then in the Import Data-tier application screen click **Next**.
