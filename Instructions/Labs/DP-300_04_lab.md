...
11.  Navigate back to the query tab you opened in step 4, and type **ROLLBACK TRANSACTION** on the line below the query. Highlight ROLLBACK TRANSACTION and execute the command.
