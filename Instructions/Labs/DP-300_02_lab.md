...
1. Start a browser, and open the Azure Portal at [http://portal.azure.com](http://portal.azure.com/), logging in with the appropriate provided credentials

2. From the Home screen, click on the **Resource Groups**.  
...
3. Review your existing Resource Group named **DP300-XXXXXX** that you will be using to deploy the resources in further tasks.  
	...
	![Picture 7](../images/dp-3300-module-22-lab-02-updated.png)

## Task 2: Create a Virtual Network

1. In the left navigation pane, click **Virtual Networks**  

	![Picture 6](../images/image003.jpg)
...
2. Click **+ Create** to open the **Create Virtual Network** page. On the **Basics** tab, complete the following information:
	...
	- Region: Select the same region where the Resource Group is pre-created (the region nearest to your location)  
...
3. Configure the virtual network’s IP range for the Azure SQL database endpoint
	...
	- In the **Edit subnet** flyout on the right, expand the Services Endpoint drop-down, and tick **Microsoft.Sql**  
...
1. From the Azure Portal, click on **+ Create a Resource** at the top of the left side navigation bar  
	...
	![Picture 14](../images/image002.jpg)

2. Search for “SQL databases” in the search box at the top, and then click **Azure SQL** in search result. 

	![](../images/image12.png)

3. Click the **Create** button

4. Now select the **SQL Database** option and click **create**.
...
4. Complete the Create SQL Database Basics screen with the following inputs and then click **Next: Networking**
	...
	- Server: click **Create new.** In the New Server sidebar, complete the form as follows:
		...
		- Server name: **dp300-lab-XXXXXX** (server name must be globally unique)
		...
		**Replace XXXXXX with the Suffix value provided in the environment details page**.
		...
		- Your New server sidebar should look similar to the one below. Leave all other settings at their default values and Click **OK**

		![A screenshot of a cell phone Description automatically generated](../images/dp-3300-module-22-lab-11u.png)

5. Go back to the **Basics** tab and Complete the following inputs:
	
	- Want to use Elastic Pool: **No**
        
	- Compute + Storage: Click **Configure database**

	- On the Configure screen, for Service tier dropdown, select **Basic(For less demanding workloads)**

	![Picture 16](../images/dp-3300-module-22-lab-12u.png)
...
2. On the SQL Server object’s navigation blade, click **Networking** under Security

	![](../images/L2-EX2-T2-S3.png)

3. Set Public network access to **selected networks**, and Allow Azure services and resources to access this server to **checked**  

	![Picture 6](../images/image4.png)
...
1. Launch Azure Data Studio (ADS) from the lab VM provided.
	...
	![Picture 24](../images/image001.jpg)

2. When Azure Data Studio opens, click the **Connections** button in Azure Data Studio’s left sidebar, then the **New Connection** button
...
3. Enter the text **Top Ten Customers by Order SubTotal**, making it Bold if desired  
	...
	![A screenshot of a cell phone Description automatically generated](../images/image004.jpg)

4. Click the **+Cell** drop down and then select **Code Cell** button to add a new cell at the end of the notebook to put a query in  
...
2. Search for “postgresql” in the search box at the top, then click **Azure Database for PostgreSQL** in the results  
	...
	![Picture 43](../images/L2-EX4-T1-S2.png)

3. Click the **Create** button

4. On the **Select Azure Database for PostgreSQL deployment option**, open the drop-down box under **Azure Database for PostgreSQL**. Select the option labeled **Single Server**. Click **Create** for the Single Server option  

	![Picture 45](../images/L2-EX4-T1-S4.png)
