...
5. Click on **No- Create Single Server** under consider creating Flexible server

6. Complete the Single Server Basics screen with the following inputs:
...
9. When the deployment is complete, click **Go to resource**
