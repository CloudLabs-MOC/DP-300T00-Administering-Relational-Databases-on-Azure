...
1. From the lab virtual machine, if you are not already in the Azure portal, start a browser session and navigate to [https://portal.azure.com](https://portal.azure.com/). 
...
3. On the Subscriptions blade, you will have one or more subscriptions. Review your Subscription name, subscription ID, and your role. 
   In your case, you should see one subscription listed.

	![Picture 3](../images/EX1-T1-S3.png)

4. Select **Resource groups** in the left navigation.
...
5. On the Resource groups blade, you should see a resource group named **DP-300-Lab01-<inject key="Suffix"></inject>**

	![Picture 7](../images/dp-3300-module-11-lab-07updated.png)


7. Locate the search bar at the top of the page. Search for **Azure SQL**. Select the search result for Azure SQL that appears in the results under Services.
...
3. On the Create a virtual machine blade, enter the following information: 
	...
	- Resource group: Select the existing resource group from the drop down menu **DP-300-Lab01-<inject key="Suffix" style="color:red" />**
	...
	- Image: **Free SQL Server License: SQL 2019 Developer on Windows Server 2019 - Gen2**
      ...
      If any policy issue appears click on **Configure VM Generation**.
	
	![](../images/image2.png)	
	
      Select **Generation 1** and **Apply**.
	...
	- Would you like to use an existing Windows Server license?: **No or leave it unchecked**.
...
4. Navigate to the **Disks** tab and review the configuration. 
	...
	![Picture 13](../images/EX1-T2-S4.png)

5. Navigate to the **Networking** tab and review the configuration. 

	![Picture 14](../images/EX1-T2-S5.png)
 
6. Navigate to the **Management** tab and review the configuration. 

	![Picture 15](../images/EX1-T2-S6.png)

	>**Note**: Verify that **Enable auto_shutdown** is off or unchecked. 
	
7. Navigate to the **Monitoring** tab and review the configuration. 

	![Picture 15](../images/EX1-T2-S7.png)
 
	>**Note**: Make sure that **Boot diagnostics** has the button for **Enable with managed storage account (recommended)** selected. 

8. Navigate to the **Advanced** tab and review the configuration. 

	![Picture 16](../images/EX1-T2-S8.png)
	

9. Navigate to the **SQL Server settings** tab and review the configuration. 

	![Picture 17](../images/EX1-T2-S9.png)
...
10. Select the **Review + create** button. Then select the **Create** button.  

    ![Picture 18](../images/EX1-T2-S10.png)

11. On the deployment blade, wait until the deployment is complete. The VM will take approximate 5-10 minutes to deploy. Then select the **Go to resource** button. 

	![Picture 19](../images/dp-3300-module-11-lab-19.png)

 
12. On the **overview** page for the virtual machine, scroll through the menu options for the resource to review what is available.
...
2. On the RDP tab, select the **Download RDP File** button. 
	...
	![Picture 22](../images/EX2-T1-S2.png)
...
5. Enter the username and password selected during the virtual machine provisioning process. Then select the **OK** button.
	- username: **dp300sqlvmlab01admin**
	- password: **pwd!DP300lab01** (or your own password which you have enter while in previous task)
