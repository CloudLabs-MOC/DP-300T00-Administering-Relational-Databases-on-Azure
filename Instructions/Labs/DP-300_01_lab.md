...
7. On the Resource groups blade, you should see a resource group named **DP-300-Lab01-<inject key="DeploymentID"></inject>**
...
6. Navigate to the **Management** tab and review the configuration. 
	...
	Verify that **Enable auto_shutdown** is off or unchecked. 
